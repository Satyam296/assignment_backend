...
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost:27017/emi-products";
var calculateEMI = function (principal, annualRate, tenureMonths) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, Product_1.default.insertMany(seedData)];
            case 3:
                result = _a.sent();
                console.log("".concat(result.length, " products inserted successfully"));
                process.exit(0);
                return [3 /*break*/, 5];
            case 4:
                error_1 = _a.sent();
